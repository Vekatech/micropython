// MCU config
#define MICROPY_HW_BOARD_NAME       "VK-RZG2LC"
#define MICROPY_HW_MCU_NAME         "RZG2LC"
...
// UART
#define MICROPY_HW_UART3_TX         (pin_P000) // Modbus (RS485)
#define MICROPY_HW_UART3_RX         (pin_P001) // Modbus (RS485)
#define MICROPY_HW_UART1_TX         (pin_P400) // REPL
#define MICROPY_HW_UART1_RX         (pin_P401) // REPL
