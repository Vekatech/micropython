...
{ Default_Handler, /* IRQ:0 */
  ...
  scif_uart_eri_isr, /* IRQ:385 SCIF1 ERI (Framing or Parity error) */
  scif_uart_bri_isr, /* IRQ:386 SCIF1 BRI (Break (BRK) or Overrun (ORER) error) */
  scif_uart_rxi_isr, /* IRQ:387 SCIF1 RXI (Receive data full) */
  scif_uart_txi_isr, /* IRQ:388 SCIF1 TXI (Transmit data empty) */
  scif_uart_tei_isr, /* IRQ:389 SCIF1 TEI (Transmit end) */
